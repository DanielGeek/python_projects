"""
Mini Pokédex Lite - FastMCP 2.0 Resources Demo (STDIO Transport)

STDIO version for Claude Desktop and Windsurf integration.
"""
...
if __name__ == "__main__":
    ...
    print("🔥 Starting Mini Pokédex Lite MCP Server (STDIO Transport)...")
    print("📡 Server running on stdio - connect with Claude Desktop or Windsurf!")
    print("🎯 Available resources:")
    print("   • poke://starters")
    print("   • poke://pokemon/1")
    print("   • poke://pokemon/pikachu")
    print("   • poke://types/fire")
    app.run()  # Default is stdio
