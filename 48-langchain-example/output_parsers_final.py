...
def demo_json_parser():
    ...
    result = chain.invoke({"place": "Salto Angel"})
...
def demo_pydantic_parser():
    ...
    class Recipe(BaseModel):
        ...
        difficulty: str = Field(description="asy, medium or hard")
    ...
    result = chain.invoke(
        {
            ...
            "Cupertino, California, USA. They make iPhones, MacBookx, and iPads."
        }
    )
...
def exercise_structured_extraction():
    ...
    Test with a moview description.
    """
