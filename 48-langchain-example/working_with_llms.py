...
def demo_init_chat_model():
    ...
    response = chat_model.invoke(
        "What is the capital of Venezuela? Answer in one word."
    )
    ...
    response = claude.invoke("What is the capital of Venezuela? Answer in one word.")
