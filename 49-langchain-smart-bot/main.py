...
if os.getenv("LANGSMITH_API_KEY"):
    ...
    print(f"LangSmith is configured. - Project: {os.environ['LANGCHAIN_PROJECT']}")
...
Always respond with accurate, helpful information.""",
    ...
    def ask(self, question: str) -> QAResponse:
        try:
            ...
            # return a greacefull error response
            return QAResponse(
