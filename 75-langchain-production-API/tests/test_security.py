...
class TestInputSanitizer:
    ...
    def test_safe_input_passes(self):
        is_safe, reason = self.sanitizer.check("What is the capital of Venezuela?")
...
class TestPIIDetector:
    ...
    def test_detects_email(self):
        found = self.detector.detect("Contact me at john.doe@example.com")
...
class TestOutputValidator:
    ...
    def test_clean_output_passes(self):
        ...
        assert output == "Caracas is the capital of Venezuela."
